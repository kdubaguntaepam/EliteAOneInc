...
namespace AutomationFramework.UI.StepDefinitions
{
    ...
    public class BlazeDemoSteps
    {
        ...
        public void WhenISelectDepartureAndDestinationCities(string departureCity, string destinationCity)
        {
        ...
        public void ThenIShouldSeeAnErrorMessageForInvalidCitySelection()
        {
            var errorMessage = _driver.FindElement(By.CssSelector("div.alert.alert-danger"));
            errorMessage.Displayed.Should().BeTrue("An error message should be displayed for invalid city selection.");
        }
    }
}
