...
{
    [Binding]
    public class VerifyPetStoreStatusCodesSteps
    {
        ...
        public VerifyPetStoreStatusCodesSteps(ScenarioContext scenarioContext)
        {
        ...
        public void WhenIUpdateThePetWithGeneratedIDWithNewDetails(Table table)
        {
            ...
            var tags = row["Tags"];
            var petId = _scenarioContext.Get<long>(PetId);
            _response = _petBusinessLogic.UpdatePet(pet